...
module.exports.latest = function(info) {
  var latest = Array.isArray(info['dist-tags'].latest)
                   ? semver_sort(info['dist-tags'].latest).pop()
...
/**
 * Convert a node-style (err, data) function into a promise-returning function
 * 
 * @param {any} obj The function, or the root contaxt
 * @param {string} method The method name (if a context) or undefined
 * @param {boolean} multiple True to pas an array of all arguments, fals only returns a single arg
 * @returns {function} The promisified function
 */
function promisify(obj, method, multiple) {
