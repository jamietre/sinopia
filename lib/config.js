...
function Config(config) {
  ...
  // some weird shell scripts are valid JSON files parsed as string
  ...
  for (let i in self.users) check_user_or_uplink(i)
  for (let i in self.uplinks) check_user_or_uplink(i)
